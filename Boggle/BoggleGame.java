...
public class BoggleGame extends JFrame {
    ...
    private static final int[] LEVEL_MAX_ITERATIONS = {
         100,
         200,
         400,
         800,
    ...
    private static final int[] LEVEL_MAX_START_POS = {
         2,
         4,
         5,
         7,
    ...
    private static final boolean requireWordInDictionary = false;
    ...
    private static final int[] LEVEL_MAX_START_POS = {
        ...
        */
        if (gameDifficulty == NURSERY) {
            Iterable<String> wordsFound = solver.getAllValidWords(board,LEVEL_MAX_ITERATIONS[NURSERY],LEVEL_MAX_START_POS[NURSERY]);
            for (String word : wordsFound) {
               if (nurseryDictionary.contains(word) || !requireWordInDictionary)
            ...
            */
            ...
            Iterable<String> wordsFound = solver.getAllValidWords(board,LEVEL_MAX_ITERATIONS[SHAKESPEARE],LEVEL_MAX_START_POS[SHAKESPEARE]);
            for (String word : wordsFound) {
               if (nurseryDictionary.contains(word) || !requireWordInDictionary)
                  opponentFoundWords.add(word);
            }
            ...
            Iterable<String> wordsFound = solver.getAllValidWords(board,LEVEL_MAX_ITERATIONS[ALGORITHMS],LEVEL_MAX_START_POS[ALGORITHMS]);
            for (String word : wordsFound) {
               if (nurseryDictionary.contains(word) || !requireWordInDictionary)
                  opponentFoundWords.add(word);
            }
            ...
            Iterable<String> wordsFound = solver.getAllValidWords(board,LEVEL_MAX_ITERATIONS[HARD],LEVEL_MAX_START_POS[HARD]);
            for (String word : wordsFound) {
               if (nurseryDictionary.contains(word) || !requireWordInDictionary)
                  opponentFoundWords.add(word);
            }
            ...
            Iterable<String> wordsFound = solver.getAllValidWords(board,LEVEL_MAX_ITERATIONS[IMPOSSIBLE],LEVEL_MAX_START_POS[IMPOSSIBLE]);
            for (String word : wordsFound) {
               if (nurseryDictionary.contains(word) || !requireWordInDictionary)
                  opponentFoundWords.add(word);
            }
